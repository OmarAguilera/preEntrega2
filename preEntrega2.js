...
let opcionesDisponibles = ["manzana", "banana", "naranja", "yogurt", "pollo", "arroz", "lasagna", "hamburguesa", "pizza", "cremaDeCacahuate", "avena", "pollo", "proteina", "huevo"];
...
while(agregarAlimento !== "fin"){
    agregarAlimento = prompt('Por favor abra la consola e ingrese un alimento de la lista de alimentos disponibles (se agregarán más), o escriba "fin" para salir');
    if (agregarAlimento !== "fin"){
        alimentosRegistrados.push(agregarAlimento)};
        console.log(alimentosRegistrados);
} 
